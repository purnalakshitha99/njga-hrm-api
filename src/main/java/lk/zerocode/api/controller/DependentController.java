...
public class DependentController {
    ...
    public List<DependentDetailResponse> getDependentByEmpId(@PathVariable("id")Long id)throws EmployeeNotFoundException,DependentNotFoundException{
        return dependentService.getDependentByEmpId(id);
    }
    @DeleteMapping("/employees/{emp_id}/dependents/{dependent_id}")
    public DependentDetailMsgResponse deleteDependent(@PathVariable ("emp_id") Long emp_id, @PathVariable("dependent_id") Long dependent_id) throws EmployeeNotFoundException, DependentNotFoundException {
