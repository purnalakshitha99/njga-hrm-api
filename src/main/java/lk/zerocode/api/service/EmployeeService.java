...
public interface EmployeeService {
    IdResponse saveBasicDetails(Long id, BasicDetailsRequest basicDetailsRequest) throws EmployeeNotFoundException;
//    BasicDetailsResponse getByEmpId(String id) throws EmployeeNotFoundException;
    ...
    ResponseEntity<String> updateBasicDetails(Long id, BasicDetailsRequest basicDetailsRequest) throws EmployeeNotFoundException;
}
